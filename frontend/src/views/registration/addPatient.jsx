...
export default function AddPatient(props){
  ...
  const [assignedDoctor, setAssignedDoctor] = useState(doctors[0].firstName);
  ...
  const [imagePreview, setImagePreview] = useState('/images/ph.webp');
...
<h1 class="font-bold text-xl text-center mb-10">Kidane Mihret Patient Registration Form</h1>
  ...
  <button onClick={handleSubmit} type="" class="bg-primary  text-white font-bold px-10 py-2 mt-5 rounded focus:outline-none shadow hover:bg-blue-700 transition-colors">Register Patient</button>
