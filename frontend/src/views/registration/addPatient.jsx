...
<h1 class="font-bold text-xl text-center mb-10">Kidane Mihret Patient Registration Form</h1>
  ...
  <div class="w-full md:w-1/2 px-3">
    ...
    <div class="w-full px-3 mt-6">
      ...
      <input class="appearance-none block w-full  text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="password" placeholder="Fill phone number"/>
      {/* <p class="text-gray-600 text-xs italic">Make it as long and </p> */}
    </div>
