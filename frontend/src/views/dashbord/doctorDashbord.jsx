        ...
        <div x-data="setup()" class="bg-black">
            <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
              ...
              <div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
                ...
                <img class="rounded-full mr-2 w-10 h-10 relative object-cover" src="https://img.freepik.com/free-photo/no-problem-concept-bearded-man-makes-okay-gesture-has-everything-control-all-fine-gesture-wears-spectacles-jumper-poses-against-pink-wall-says-i-got-this-guarantees-something_273609-42817.jpg?w=1800&t=st=1669749937~exp=1669750537~hmac=4c5ab249387d44d91df18065e1e33956daab805bee4638c7fdbf83c73d62f125" alt=""/>
                 ...
                 <div>
                    <p class="font-medium group-hover:text-indigo-400 leading-4">Doctor Samson Abebe</p>
                    <span class="text-xs text-slate-400">Dentist</span>
                </div>
                </div>
              ...
              <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
                ...
                {/* <!-- Statistics Cards --> */}
              <div class = "flex flex-wrap  ml-4  mr-4 justify-center my-5 -mx-2">
               <div class = "w-full lg:w-1/3 p-2">
                 <div class = "flex items-center flex-row w-full bg-blue-500 dark:from-cyan-500 dark:to-blue-500 from-indigo-500 via-purple-500 to-pink-500 rounded-md p-3">
            ...
            <div class = "w-full md:w-1/2 lg:w-1/3 p-2">
                <div class = "flex items-center flex-row w-full bg-blue-500 dark:from-cyan-500 dark:to-blue-500 from-indigo-500 via-purple-500 to-pink-500 rounded-md p-3">
                    ...
                    <img src="/icons/lab.png" alt="" class="w-8 h-8 rounded-full h-30 stroke-current bg-blue-500 text-blue-800 dark:text-gray-800 transform transition-transform duration-500 ease-in-out"/>
                    </div>
                    <div class = "flex flex-col justify-around flex-grow ml-5 text-white">
                        <div class = "text-2xl whitespace-nowrap">
                            Labratories
