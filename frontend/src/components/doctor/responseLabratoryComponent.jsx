...
export default function ResponseLabratoryComponent(props) {
    return <>
                        ...
                        <table class="w-full sm:w-full">
                            <thead>
                                <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                    ...
                                    <th class="px-4 py-3">Patient Contact</th>
                                    <th class="px-4 py-3">Lab Doctor Name</th>
                                    <th class="px-4 py-3">Lab Doctor contact</th>
                                    <th class="px-4 py-3">Date</th>
                                    <th class="px-4 py-3">Time</th>
                                    <th class="px-4 py-4">Response</th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                <tr className="text-gray-700 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 dark:text-gray-400">
                                    ...
                                    <td className="px-4 py-3 text-sm">0909222730</td>
                                    <td className="px-4 py-3">
                                        <div className="flex items-center text-sm">
                                            <div className="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                                <img
